...
#define MY_USB_VENDOR_ID 0xcafe
#define MY_USB_PRODUCT_ID 0x4013
             ...
             const struct usb_device_id *id)
{
   ...
   data->led.name = kasprintf(GFP_KERNEL, "tiny%s-%s:blue:activity",
   ...
   data->led2.name = kasprintf(GFP_KERNEL, "tiny%s-%s:red:activity",
                              dev_driver_string(&data->udev->dev),
                              dev_name(&data->udev->dev));
   data->led2.brightness_set = usb_avr_led2_set;
   data->led2.brightness = LED_OFF;
   data->led2.max_brightness = 1;
   ...
   INIT_WORK(&data->work2, usb_avr_led_work2);
